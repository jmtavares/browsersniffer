...
*/
/* global bowser */
!function(a,b,c){"use strict";b[a]=c()}("browsersniffer",this,function(){"use strict";function a(){return{chrome:"Chrome",firefox:"Firefox",msie:"Internet Explorer",msedge:"Internet Explorer Edge",android:"Android Native",ios:"iOS Native",opera:"Opera",phantom:"PhantomJS",phantomjs:"PhantomJS",safari:"Safari",seamonkey:"SeaMonkey",blackberry:"BlackBerry",webos:"WebOS",silk:"Amazon Kindle Browser",bada:"Bada",tizen:"Tizen",sailfish:"Sailfish"}}function b(){return{android:"Android",windowsphone:"Windows Phone",iphone:"iOS Iphone",ipad:"iOS Ipad",ipod:"iOS Ipod",blackberry:"Blackberry",firefoxos:"Firefox OS",webos:"WebOS",bada:"Bada",tizen:"Tizen",sailfish:"Sailfish"}}function c(){var c,d,e="Unknown Browser",f="Unknown Operating System",g={},h=a(),i=b();try{c=bowser}catch(j){}for(d in c)h.hasOwnProperty(d)&&(e=h[d]),i.hasOwnProperty(d)&&(f=i[d]);return g.browser=e,g.mobileOperatingSystem=f,g.version=c.version,g.bowser=c,g}return{detect:c}}),/*!
