...
/* global bowser */
/* global window */
!function(a,b,c){"use strict";b[a]=c()}("browsersniffer",this,function(){"use strict";function a(){return{chrome:"Chrome",firefox:"Firefox",msie:"Internet Explorer",msedge:"Internet Explorer Edge",ios:"iOS Native",opera:"Opera",phantom:"PhantomJS",phantomjs:"PhantomJS",safari:"Safari",seamonkey:"SeaMonkey",blackberry:"BlackBerry",webos:"WebOS",silk:"Amazon Kindle Browser",bada:"Bada",tizen:"Tizen",sailfish:"Sailfish"}}function b(){return{android:"Android",windowsphone:"Windows Phone",iphone:"iPhone",ipad:"iPad",ipod:"iPod",blackberry:"Blackberry",firefoxos:"Firefox OS",webos:"WebOS",bada:"Bada",tizen:"Tizen",sailfish:"Sailfish"}}function c(a){window.navigator&&(a.language=window.navigator.language,a.maxTouchPoints=window.navigator.maxTouchPoints,a.javaEnabled=window.navigator.javaEnabled(),a.onLine=window.navigator.onLine)}function d(a){window.screen&&(a.currentResolution=window.screen.width+"x"+window.screen.height,a.colorDepth=window.screen.colorDepth)}function e(a){var b,c={};if(window.performance&&window.performance.timing){b=window.performance.timing.navigationStart;for(var d in window.performance.timing)"navigationStart"!==d&&(window.performance.timing[d]<b?c[d]=window.performance.timing[d]:c[d]=window.performance.timing[d]-b)}a.timing=c}function f(){var f,g,h,i="Unknown Browser",j="Unknown Operating System",k=a(),l=b();try{f=bowser}catch(m){}for(h in f)k.hasOwnProperty(h)&&(i=k[h]),l.hasOwnProperty(h)&&(j=l[h]);return g={browser:i,version:f.version,mobileOS:j,mobileOSVersion:f.osversion,bowser:f},c(g),d(g),e(g),g}return{detect:f}}),/*!
